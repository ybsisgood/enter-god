...
$this->title = 'Update Outlets : ' . $model->name;
            ...
            <div class="card">
                <div class="card-body">
                    <div class="outlets-create">
                        ...
                        <?= $form->field($model, 'address')->textInput(['maxlength' => true, 'value' => $model->detail_info['address'] ?? ''])->hint('Pakai | untuk pemisah line alamat, perbaris maksimal 25') ?>
