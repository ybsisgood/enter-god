...
<div class="payments-index">
    ...
    <p>
        ...
        <?= Html::a('Completed Payment', ['payment-completed'], ['class' => 'btn btn-primary btn-sm waves-effect waves-light']) ?>
        <?= Html::a('Expired Payment', ['payment-expired'], ['class' => 'btn btn-danger btn-sm waves-effect waves-light']) ?>
        <?= Html::a('Refund Payment', ['payment-refund'], ['class' => 'btn btn-outline-warning btn-sm waves-effect waves-light']) ?>
    </p>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-2">
                <div class="col-12">
                    <?= Html::a('Reset Filter', ['payment-refund'], ['class' => 'btn btn-outline-primary btn-sm mb-1 waves-effect waves-light float-end']) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
